<?php
include 'header.php';
 $sql = mysqli_query($conn,"SELECT * FROM `our_blog` WHERE `id` = '".$_GET['id']."'");
...
<h4 class="card-title">Add blog  Form</h4>  
              ...
              <form method="POST" action="insert.php?act=update_blog" enctype="multipart/form-data">
