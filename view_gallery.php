...
echo "<tr>
<td>" . $counter . "</td>
<td><img src='../images/" . $row['gallery_image'] . "' style='height:100px;width:100px;margin:0px;padding:0px;' /></td>
<td><a class=' btn btn-sm btn-white text-danger ' href='view_gallery.php?page=gallery&id=" . $row['id'] . "'><i class='far fa-trash-alt mr-2'></i>Delete</a></td>
</tr>";
$counter++;
}
}
